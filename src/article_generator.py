...
<p>リムショット（フチを叩く）、オープンリムショット、ゴーストノート（弱く叩く）など、様々な音色があります。</p>

<p>打ち込みでも、これらの音色の違いを表現することが大切です。</p>

<h3>ベロシティレイヤーを活用しましょう</h3>

<p>ほとんどのドラム音源には、ベロシティの強弱に応じて異なるサンプル（実際に録音された音）が鳴る仕組みがあります。</p>

<p>これを「ベロシティレイヤー」と呼びます。</p>
...
<p>このように、表を使うことで情報が整理されて比較しやすくなります。</p>
...
<p>数値を表で示すことで、設定の全体像が把握しやすくなります。</p>
