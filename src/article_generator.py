...
3. **数字を使う場合の厳守事項**：タイトルの数字と本文の項目数は必ず一致させること
4. ターゲット明確（初心者、DTMer、宅録派など）
5. ベネフィット明示（後悔しない、差がつく、劇的に改善など）
6. 強い言葉を使う（絶対に、即効、完全、徹底など）
7. 30〜40文字程度

**重要：すべてのパターンをバランスよく使い、同じパターンが続かないようにすること！**
